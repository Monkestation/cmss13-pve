...
#define MAIN_SHIP_DEFAULT_NAME "USS Golden Arrow (Gross Dragmeme Version)"
#define SHIP_MAP_NAMES list("USS Almayer", "USS Golden Arrow",  "USS Golden Arrow (Classic)", "USS Golden Arrow (Gross Dragmeme Version)", "SSV Chapaev", "USS Rover", "USCSS Firefly", "USCSS Obsidian Falk", "USCSS Onyx Karain", "HMS Brynhild")
